FROM docker.io/rclone/rclone:1.63.1 AS rclone
FROM docker.io/kopia/kopia:20230902.0.182321@sha256:05ff1e8152b1ea693769b38d0f94edebe67eed0743d6c8fbde8b1d6ba7d37d22 AS kopia
